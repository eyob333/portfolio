                ...
                <div class="theme">
                    <div class="icons icons-t">
                       <svg width="170" height="162" viewBox="0 0 170 162" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M88.5494 160.083C88.4823 160.083 88.4152 160.083 88.3482 160.083L86.4358 2.10898C87.069 2.09335 87.7041 2.08387 88.341 2.08303C132.256 2.02512 167.888 37.3564 167.945 80.9781C168.003 124.6 132.465 160.025 88.5494 160.083Z" fill=""#ffffff00"" stroke="#ffffff00" stroke-width="3"/>
                        </svg>
                    </div>
                </div>
